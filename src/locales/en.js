export const enLang = {
    menu: ['About', 'Videos','Location', 'Event'],
    description: [
    ...
    contact: 'Book now',
    titleEvent: 'Event',
    textEvent: ['"Discover Las Palmeras, the perfect venue for your special events! Our estate is the ideal setting for magical weddings and unforgettable birthday celebrations. With space for up to 200 guests and outstanding facilities, your event will be a unique experience in a charming environment. Make your dreams come true at Las Palmeras!"'],
